...
const Main = () => {
  ...
  return (
    <>
      ...
      {confluenceCredential ? (
        <>
          <div className="flex mb-1 text-sm">
            ...
            <p className="my-auto">Existing Confluence Username and Password: </p>
            <p className="ml-1 italic my-auto max-w-md truncate">
        ...
        <>
          <p className="text-sm">
            The app use Confluence Server(self-hosted), you need username and password for Confluence connector</p>
      ...
      <h2 className="font-bold mb-2 mt-6 ml-auto mr-auto">
        Step 2: Add spaces/URL you want to make searchable?
      </h2>
      {confluenceCredential ? (
        <>
          ...
          <div className="border-solid border-gray-600 border rounded-md p-6 mt-4">
            ...
            <ConnectorForm<ConfluenceConfig>
              ...
              refreshFreq={24 * 60 * 60} // 10 minutes
