...
const SectionTitle = ({ children }: { children: string }) => (
  <div className="font-medium text-sm flex text-logo-white">{children}</div>
);
            ...
            {sources
              ...
              .map((source) => (
                ...
                >
                  ...
                  <span className="ml-2 text-sm text-logo-white">
                    {source.displayName}
                  </span>
                </div>
              ))}
            ...
            return {
              ...
              display: (
                <>
                  {" "}
                  {getSourceIcon(source.internalName, 16)}
                  <span className="ml-2 text-sm text-logo-lightblue-600">
                    {source.displayName}
                  </span>
                </>
              ),
