    ...
    if (shouldBeBold != previousIsBold) {
      if (currentText) {
        if (previousIsBold) {
          ...
          finalJSX.push(
            <b key={index} className="text-gray-200 bg-logo-lightblue-600">
              {currentText}
            </b>
          );
        } else {
...
export const DocumentDisplay = ({
  ...
  return (
    <div
      ...
      className="text-md mb-3 bg-white shadow-lg p-2 rounded-lg"
      onMouseEnter={() => {
        setIsHovered(true);
      }}
    ...
    >
      <div className="flex relative">
        {document.score !== null && (
          <div
            className={
              ...
              (isSelected ? "-left-16 w-16" : "-left-14 w-14")
            }
          >
            {isSelected && (
        ...
        >
          ...
          <p className="truncate break-all ml-2 my-auto text-gray-800">
      ...
      <p className="pl-1 pt-2 pb-3 text-gray-600 break-words">
