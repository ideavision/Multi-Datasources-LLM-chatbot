  ...
  return (
    <div>
      <div
        ...
        rounded  
        select-none 
        ${isNotControllable ? "" : "hover: cursor-pointer text-gray-200"}`}
        onClick={() => {
      ...
      >
        ...
        <div className="my-auto text-md text-gray-600 italic">{header}</div>
      ...
      {finalIsOpen && <div className="pb-1 mx-2 text-md mb-1 text-gray-600">{body}</div>}
    </div>
  );
};
