...
export const Header: React.FC<HeaderProps> = ({ user }) => {
  ...
  return (
    <header className="bg-logo-lightblue-400 text-gray-200 py-4">
      <div className="mx-8 flex">
        <Link href="/">
          <div className="flex">
            <div>
            <img src="https://www.paysera.lt/v2/compiled/logo-white-v2.a529473ad77a993e276970c4fcceadc2.svg" width="220px" />
            </div>
            <h6 className="flex text-2xl font-bold my-auto pl-2 text-logo-white"></h6>
          </div>
        </Link>
