...
from payserai.configs.payseraibot_configs import PAYSERAI_BOT_NUM_DOCS_TO_DISPLAY
from payserai.configs.payseraibot_configs import ENABLE_SLACK_DOC_FEEDBACK
...
from payserai.payseraibot.slack.utils import build_feedback_block_id
from payserai.payseraibot.slack.utils import remove_slack_text_interactions
from payserai.payseraibot.slack.utils import translate_vespa_highlight_to_slack
from payserai.direct_qa.interfaces import payseraiQuote
from payserai.server.models import SearchDoc
from payserai.utils.text_processing import replace_whitespaces_w_space
...
def build_documents_blocks(
    ...
    query_event_id: int,
    num_docs_to_display: int = PAYSERAI_BOT_NUM_DOCS_TO_DISPLAY,
