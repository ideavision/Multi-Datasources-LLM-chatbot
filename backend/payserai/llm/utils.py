...
def translate_payserai_msg_to_langchain(msg: ChatMessage) -> BaseMessage:
    if (
        ...
        or msg.message_type == MessageType.payserai
    ):
        # TODO save at least the payserai responses to postgres
        raise ValueError(
            "System and payserai messages are not currently part of history"
        )
