...
# DISABLE_GENERATIVE_AI will turn of the question answering part of payserai.
# Use this if you want to use payserai as a search engine only without the LLM capabilities
...
# Miscellaneous
#####
PERSONAS_YAML = "./payserai/chat/personas.yaml"
